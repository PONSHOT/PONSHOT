import {PonsPredictionAbi, UniswapV3PonsOracleAbi} from "./abis/index.js";
...
export function marketReads(refs: MarketRefs) {
  ...
  return {
    ...
    treasuryAmount: () => ({...p, functionName: "treasuryAmount"}) as const,
    ...
    treasuryFeeBps: () => ({...p, functionName: "treasuryFeeBps"}) as const,
