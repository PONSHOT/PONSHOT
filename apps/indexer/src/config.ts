...
export interface IndexerConfig {
  ...
  prediction: Address;
  oracle: Address;
  /** Zero when the deployment predates buyback-and-burn; burn events are then skipped. */
  burner: Address;
  pons: Address;
  weth: Address;
  pool: Address;
...
export function loadConfig(): IndexerConfig {
  ...
  return {
    ...
    burner: (d.PonsBuybackBurner as Address) ?? ("0x0000000000000000000000000000000000000000" as Address),
