  ...
  return (
    <>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Stat label="Allocated to buyback and burn" value={`${formatEth(wei(data.burn_fees_accrued))} ETH`} />
        ...
        <Stat
          label="Rounds with no winners"
          value={data.all_lost_rounds}
          sub={`${formatEth(wei(data.all_lost_burned))} ETH burned in full`}
        />
      </div>
