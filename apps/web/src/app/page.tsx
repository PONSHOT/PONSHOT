...
export default function PredictPage() {
  ...
  const prevBet = useUserBet(previous?.epoch);
  ...
  return (
    <>
      ...
      */}
      ...
      {/*
        Previous / Live / Entering, above the panel rather than below it. The three rounds
        overlap by design and that structure is the product: there is always a future round
        open, which is what makes a late keeper harmless. Showing only the round you can
        bet on hides it.
      */}
      <div className="mt-4">
        <RoundRail
          ...
          nextPhase={nextPhase.data as number | undefined}
          previousBet={prevBet.data as BetInfo | undefined}
          liveBet={liveBet.data as BetInfo | undefined}
          nextBet={nextBet.data as BetInfo | undefined}
          currentPrice={twap}
        />
